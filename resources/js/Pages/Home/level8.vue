<template>
  ...
  <div class="info-container" style="padding: 10px; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
    <span class="score" style="display: flex; align-items: center; text-align: left;">
      <img src="assets/images/score-icon.png" alt="Score Icon" style="width: 20%; margin-right: 10px;">
      Score: {{ score }}
    </span>
  ...
  <div class="game-container">
    ...
    <p style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);" class="game-slogan">Level 08</p>
