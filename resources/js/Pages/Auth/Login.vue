...
<template>
    ...
    <div class="game-container">
        <h3 style="padding: 10px; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); font-size: 3rem;">LOGIN</h3>
    ...
    <form @submit.prevent="submit" style="padding-left: 400px; padding-right: 400px;">
        ...
        <div class="block mt-4 flex items-center justify-between">
            <label class="flex items-center">
                ...
                <span class="input-label-lg">&nbsp;Remember me</span>
            </label>
        ...
        <div class="block mt-4 flex items-center justify-between mt-4">
            <Link v-if="canResetPassword" :href="route('password.request')" class="underline input-label-lg">
            Forgot your password?
            </Link>
            <Link v-if="canResetPassword" :href="route('register')" class="underline input-label-lg">
